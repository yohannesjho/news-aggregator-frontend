...
function Politics({tech}) {
    return (
        <div className="px-8 py-8">
            <div className="grid grid-cols-4 gap-8">
                <div className="col-span-3">
                    <div className="flex justify-between items-center my-8">
                        <h2 className="md:text-2xl ">Politics</h2>
                        <a className="flex space-x-1 cursor-pointer hover:text-blue-400 duration-200">More in politics <ArrowBigRight /></a>
                    </div>
